...
'<button id="bEdit" type="button" class="btn btn-sm btn-warning bEdit" toggle="tooltip" data-animation="true" title="Fitur Publish" onclick="butRowEdit(this);">' +
'<span class="fa fa-pencil-alt" > </span>'+
'</button>'+
'<button id="bElim" type="button" class="btn btn-sm btn-secondary d-none" data-toggle="popover" data-animation="true" data-placement="bottom" title="Fitur Publish" data-content="Mohon maaf fitur ini belum bisa digunakan (masih dalam pengembangan)" onclick="butRowPublish(this);">' +
'<span class="fa fa-power-off" > </span>'+
'</button>'+
'<button id="bAcep" type="button" class="btn btn-sm btn-success" toggle="tooltip" data-animation="true" data-placement="bottom" title="accept" style="display:none;" onclick="butRowAcep(this);">' + 
'<span class="fas fa-check" > </span>'+
'</button>'+
'<button id="bCanc" type="button" class="btn btn-sm btn-danger" toggle="tooltip" data-animation="true" data-placement="bottom" title="cancel" style="display:none;" onclick="butRowCancel(this);">' + 
...
'</button>'+
  ...
  '</button>'+
  '<button id="bElim" type="button" class="btn btn-sm btn-default" onclick="butRowPublish(this);">' +
...
function butRowPublish(but) {  //Elimina la fila actual
  var $row = $(but).parents('tr');  //accede a la fila
  console.log($row);
